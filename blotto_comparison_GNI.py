...
class Blotto(object):
    ...
    def build_network_pure(self):
        ...
        self.local_expected_utility1_pure = tf.reduce_sum(tf.nn.tanh(self.player1_action_pure_local - self.player2_action_pure))
        self.local_expected_utility2_pure = -tf.reduce_sum(tf.nn.tanh(self.player1_action_pure - self.player2_action_pure_local))
    ...
    def build_model(self):
        self.file_out = open('comparison_blotto_3.txt','w')
